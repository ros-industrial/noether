...
TEST(ViewerTest, TestCase1)
{
  ...
  std::string path = "/home/alex/path_planning_ws/src/sample_point_clouds/pick0/cloud.pcd";

  std::string path2 = "/home/alex/path_planning_ws/src/sample_point_clouds/config/background.pcd";
  ...
  vtkSmartPointer<vtkPolyData> background = vtkSmartPointer<vtkPolyData>::New();
  // data = vtk_viewer::createMesh(points);

  vtkSmartPointer<vtkPolyData> copy_data = vtkSmartPointer<vtkPolyData>::New();

  vtk_viewer::loadPCDFile(path, data, path2);
