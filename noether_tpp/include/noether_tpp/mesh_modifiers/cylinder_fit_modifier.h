 ...
 * @brief Mesh modifier that fits a specifiable number of cylinders to the input mesh and returns the fitted primitive
 * models
 ...
 */
class CylinderFitModifier : public RansacPrimitiveFitMeshModifier
{
public:
  /**
   * @brief Constructor
   ...
   */
  CylinderFitModifier(float min_radius,
                      float max_radius,
...
protected:
  CylinderFitModifier() = default;
  DECLARE_YAML_FRIEND_CLASSES(CylinderFitModifier)
...
FWD_DECLARE_YAML_CONVERT(noether::CylinderFitModifier)
