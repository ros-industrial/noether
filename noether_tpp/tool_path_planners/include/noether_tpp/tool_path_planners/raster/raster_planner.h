...
{
/**
 * @brief Interface for various methods to generate the direction of raster paths.  The direction generated will move
 * along the line from the first point to the second, then third, etc.
 */
...
public:
  ...
  /**
   * @brief Creates a modifier that enforces the definition of a raster path on the path generated by a RasterPlanner.
   * It will enforce uniform waypoint orientation, uniform raster direction, and consistent raster ordering.
   * @return
   */
