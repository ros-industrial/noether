...
public:
  ...
  /**
   * @brief Creates a modifier that enforces the definition of a raster path on the path generated by a RasterPlanner.  It will enforce uniform waypoint orientation, uniform raster direction, and consistent raster ordering.
   * @return
   */
