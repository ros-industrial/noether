...
namespace noether
{
StraightDepartureModifier::StraightDepartureModifier(double offset_height, double n_points)
  : offset_height_(offset_height), n_points_(n_points)
{
}

ToolPaths StraightDepartureModifier::modify(ToolPaths tool_paths) const
{
  for (ToolPath& tool_path : tool_paths)
  {
    ...
    {
      Eigen::Isometry3d radius_center = segment.back() * Eigen::Translation3d(0.0, 0.0, offset_height_);
