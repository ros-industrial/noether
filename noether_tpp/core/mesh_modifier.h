...
/**
 * @brief The MeshModifier class - a common interface for mesh modifications.  Since some
...
{
public:
  virtual std::vector<pcl::PolygonMesh> modify(const pcl::PolygonMesh& mesh) = 0;
};
