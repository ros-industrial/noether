...
#include <tool_path_planner/ceres_tool_path_planner.h>

namespace tool_path_planner
{

  CeresToolPathPlanner::CeresToolPathPlanner()
  {
    debug_on_ = false;
  }

  void CeresToolPathPlanner::planPaths(const vtkSmartPointer<vtkPolyData> mesh, std::vector<ProcessPath>& paths)
  {
    setInputMesh(mesh);
    paths_.clear();
  ...
  void CeresToolPathPlanner::planPaths(const std::vector<vtkSmartPointer<vtkPolyData> > meshes, std::vector< std::vector<ProcessPath> >& paths)
  {
  ...
  void CeresToolPathPlanner::planPaths(const std::vector<pcl::PolygonMesh>& meshes, std::vector< std::vector<ProcessPath> >& paths)
  {
    for(int i = 0; i < meshes.size(); ++i)
    {
      std::vector<ProcessPath> new_path;
  ...
  void CeresToolPathPlanner::planPaths(const pcl::PolygonMesh& mesh, std::vector<ProcessPath>& paths)
  {
  ...
  void CeresToolPathPlanner::setInputMesh(vtkSmartPointer<vtkPolyData> mesh)
  {
    if(!input_mesh_)
    {
  ...
  bool CeresToolPathPlanner::computePaths()
  {
  ...
  bool CeresToolPathPlanner::getFirstPath(ProcessPath& path)
  {
  ...
  bool CeresToolPathPlanner::getNextPath(const ProcessPath this_path, ProcessPath& next_path, double dist)
  {
  ...
  bool CeresToolPathPlanner::checkPathForHoles(const ProcessPath path, std::vector<ProcessPath>& out_paths)
  {
    // use cutting mesh to find intersection line
    vtkSmartPointer<vtkPolyData> intersection_line = vtkSmartPointer<vtkPolyData>::New();
    vtkSmartPointer<vtkParametricSpline> spline = vtkSmartPointer<vtkParametricSpline>::New();
  ...
  vtkSmartPointer<vtkPolyData> CeresToolPathPlanner::createStartCurve()
  {
  ...
  bool CeresToolPathPlanner::getCellCentroidData(int id, double* center, double* norm, double& area)
  {
  ...
  bool CeresToolPathPlanner::findIntersectionLine(vtkSmartPointer<vtkPolyData> cut_surface,
  ...
  void CeresToolPathPlanner::resamplePoints(vtkSmartPointer<vtkPoints>& points)
  {
    vtkSmartPointer<vtkParametricSpline> spline = vtkSmartPointer<vtkParametricSpline>::New();
  ...
  void CeresToolPathPlanner::smoothData(vtkSmartPointer<vtkParametricSpline> spline, vtkSmartPointer<vtkPolyData>& points, vtkSmartPointer<vtkPolyData>& derivatives)
  {
    vtkSmartPointer<vtkPoints> new_points = vtkSmartPointer<vtkPoints>::New();
  ...
  void CeresToolPathPlanner::sortPoints(vtkSmartPointer<vtkPoints>& points)
  {
  ...
  void CeresToolPathPlanner::generateNormals(vtkSmartPointer<vtkPolyData>& data)
  {
  ...
  void CeresToolPathPlanner::estimateNewNormals(vtkSmartPointer<vtkPolyData>& data)
  {
  ...
  vtkSmartPointer<vtkPolyData> CeresToolPathPlanner::createOffsetLine(vtkSmartPointer<vtkPolyData> line, vtkSmartPointer<vtkPolyData> derivatives, double dist)
  {
  ...
  vtkSmartPointer<vtkPolyData> CeresToolPathPlanner::createSurfaceFromSpline(vtkSmartPointer<vtkPolyData> line, double dist)
  {
